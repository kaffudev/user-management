package com.jfka.um.persistence.setup;

import com.google.common.base.Preconditions;
import com.google.common.collect.Sets;
import com.jfka.common.spring.util.Profiles;
...
import com.jfka.um.util.Um;
import com.jfka.um.util.Um.Privileges;
...
import static com.jfka.um.util.Um.Roles.*;
...
public class SecuritySetup implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void createRoles() {
        ...
        createRoleIfNotExisting(ROLE_ADMIN, Sets.<Privilege> newHashSet(canUserRead, canUserWrite, canRoleRead, canRoleWrite, canPrivilegeRead, canPrivilegeWrite));
    }
    ...
    final void createUsers() {
        final Role roleAdmin = roleService.findOneByName(ROLE_ADMIN);
